...
aws s3 sync "${ROOT_FOLDER}"/www2/ s3://"${UPDATES_R2_BUCKETS}"/ --profile updates-jenkins-io --no-progress --size-only --delete --exclude="updates/*" --endpoint-url "${UPDATES_R2_ENDPOINT}"
